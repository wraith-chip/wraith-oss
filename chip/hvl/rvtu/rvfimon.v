...
// EDITS: Div/Rem instructions patched to prevent truncation error
//
// Command line options: -i rv32im -c 1 -r 0 -a -p rvfimon
...
module rvfimon_isa_spec (
  ...
  rvfimon_insn_mulhsu insn_mulhsu (
    .rvfi_valid(rvfi_valid),
    .rvfi_insn(rvfi_insn),
    .rvfi_pc_rdata(rvfi_pc_rdata),
    .rvfi_rs1_rdata(rvfi_rs1_rdata),
...
module rvfimon_insn_div (
  ...
  wire [32-1:0] result = rvfi_rs2_rdata == 32'b0 ? {32{1'b1}} :
                                         ...
                                         32'(33'($signed(rvfi_rs1_rdata)) / 33'($signed(rvfi_rs2_rdata)));
